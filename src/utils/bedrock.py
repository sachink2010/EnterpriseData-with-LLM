...
def get_bedrock_client(assumed_role=None, region='us-east-1'):
    boto3_kwargs = {}
    session = boto3.Session()
    print(f"Create new client\n  Using region: {os.environ.get('AWS_DEFAULT_REGION',region)}")
    ...
    if assumed_role:
        ...
        bedrock_client = session.client(service_name='bedrock', config=retry_config)
